...
/****** Object:  Database [POS_System]    Script Date: 27-May-21 8:33:04 PM ******/
CREATE DATABASE [POS_System]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'POS_System', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\POS_System.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'POS_System_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\POS_System_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
ALTER DATABASE [POS_System] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [POS_System] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [POS_System] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [POS_System] SET QUERY_STORE = OFF
GO
